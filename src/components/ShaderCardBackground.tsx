...
// Adapted from the provided ShaderBackground: same plasma-line technique,
// recolored to open on purple (echoing Impulse's blue/purple) and resolve
// into the Avanza forest green (matching the OS card and the rest of the
// brand), with warm gold line accents instead of the original violet lines.
// Scoped to fill its parent container (absolute, not fixed) so it sits
// behind the card row specifically rather than the whole page.
...
export default function ShaderCardBackground({ className = "" }: { className?: string }) {
