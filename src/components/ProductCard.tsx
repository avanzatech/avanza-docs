...
export default function ProductCard({ eyebrowDot, glowColor, name, subtitle, desc, cta, onClick, delay, image }: Props) {
  ...
  return (
    <motion.button
      ...
      className={`group relative flex ${image ? "aspect-auto min-h-[320px] md:aspect-[4/3] md:min-h-0" : "min-h-[440px]"} flex-col justify-end overflow-hidden rounded-[24px] border p-9 text-left transition-[border-color,box-shadow,transform] duration-300 ${image ? "" : "backdrop-blur-2xl"}`}
    >
